...
# Call the Sheets API
a = [['Username','Password'],['user-director','coolman'],['user-manager','manager'],['user-marketing','marketer'],["user-worker",'worker']]
...
if True:
  ...
  q = [l]
  print(q)
  send = sheet.values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range="Register!A{}".format(i), valueInputOption="USER_ENTERED", body={'values':q}).execute()
else:
  print("You are wrong!")
print('Welcome!!!')
